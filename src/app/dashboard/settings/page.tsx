...
export default function SettingsPage() {
  ...
  return (
    <div>
      ...
      {/* Profile Section */}
      <div className="rounded-2xl border border-white/8 bg-[rgba(0,0,0,0.95)] p-6 mb-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Link
          ...
          className="group rounded-2xl border border-white/8 bg-[rgba(0,0,0,0.95)] p-6 hover:border-[#34d399]/30 transition-all duration-300"
        >
        ...
        <Link
          ...
          className="group rounded-2xl border border-white/8 bg-[rgba(0,0,0,0.95)] p-6 hover:border-[#a78bfa]/30 transition-all duration-300"
        >
