...
export default function DashboardOverview() {
  return (
    <div>
      <PageHeader
        title="Welcome back"
        description="Here's what's happening with your AI agents today."
      />
      ...
      {/* Quick Actions */}
      <div className="mb-8">
        <h3 className="text-sm font-semibold text-white/50 uppercase tracking-widest mb-4">Quick Actions</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          >
            ...
            <h4 className="text-base font-semibold text-white mb-1 font-display">Create a Script</h4>
            <p className="text-sm text-white/40">Upload your sales script and set up objection handlers.</p>
          </Link>
          <Link
          ...
          >
            ...
            <h4 className="text-base font-semibold text-white mb-1 font-display">Choose a Voice</h4>
            <p className="text-sm text-white/40">Select a voice, language, and personality for your agent.</p>
          </Link>
          <Link
          ...
          >
            ...
            <h4 className="text-base font-semibold text-white mb-1 font-display">Import Leads</h4>
            <p className="text-sm text-white/40">Upload a CSV with your contacts to start calling.</p>
          </Link>
        </div>
      </div>
      ...
      {/* Recent Calls */}
      <div>
        <h3 className="text-sm font-semibold text-white/50 uppercase tracking-widest mb-4">Recent Calls</h3>
        <div className="rounded-2xl border border-white/8 bg-[rgba(14,14,22,0.95)] p-8 text-center">
          <p className="text-sm text-white/30">No calls yet. Create a script and import leads to get started.</p>
        </div>
      </div>
    </div>
  );
