...
const faqs = [
  ...
  { q: "How fast does the AI respond?", qUa: "Як швидко відповідає AI?", a: "Under 0.5 second end-to-end latency. The conversation feels completely natural — no awkward pauses or robotic delays.", aUa: "Менше 0.5 секунди наскрізної затримки. Розмова відчувається абсолютно природно — жодних незручних пауз чи роботизованих затримок." },
