  ...
  return (
    <>
      ...
      <div className="fixed top-0 left-1/2 -translate-x-1/2 z-50 pt-4 sm:pt-6 hidden md:flex items-center gap-3">
        <a href="/dashboard" className="flex items-center bg-[rgba(10,10,15,0.4)] border border-white/10 backdrop-blur-xl py-1.5 px-4 rounded-full shadow-lg shadow-black/20 text-[13px] font-semibold text-white/60 hover:text-white transition-colors">
          Dashboard
        </a>
